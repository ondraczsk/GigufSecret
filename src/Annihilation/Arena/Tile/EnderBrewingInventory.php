...
class EnderBrewingInventory extends ContainerInventory{

    public $brewTime = EnderBrewingStand::MAX_BREW_TIME;

    public $owner;

    public function __construct(EnderBrewingStand $tile, string $owner){
